...
#   INGEST_FILE_SIZE_BYTES      Small file size for seed phase (default: 102400 = 100 KB)
#   TARGET_FILE_SIZE_BYTES      Compaction target file size   (default: 67108864 = 64 MB)
#   TOTAL_INGEST_BYTES          Total bytes to seed           (default: 104857600 = 100 MB)
