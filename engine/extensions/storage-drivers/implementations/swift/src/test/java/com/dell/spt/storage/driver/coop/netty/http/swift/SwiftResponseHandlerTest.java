...
public class SwiftResponseHandlerTest {
	...
	public void fullContentTest() throws IOException {
		...
		Assertions.assertEquals(expectedContent.array().length, newContentChunk.array().length);
	...
	public void unicodeContentTest() throws IOException {
		...
		Assertions.assertEquals(expectedContent.array().length, actualContent.array().length);
	...
	public void partContentTest1() throws IOException {
		...
		Assertions.assertEquals(expectedContent.array().length, fullContentChunk.array().length);
