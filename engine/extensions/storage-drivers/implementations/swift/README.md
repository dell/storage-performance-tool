...
* Data item operation types:
    * `create`
        ...
        * [Dynamic Large Objects](../../../../../../src/main/java/com/dell/spt/base/item/op/composite/README.md)
    * `read`
        * full
        * random byte ranges
        * fixed byte ranges
...
* [Defect GOOSE-1316](https://spt-issues.atlassian.net/browse/GOOSE-1316): unable to verify the response content in
