...
public class DataOperationsBuilderImpl<I extends DataItem, O extends DataOperation<I>>
	...
	@Override
	public DataOperationsBuilderImpl<I, O> opType(final OpType opType) {
		super.opType(opType);
		return this;
	}

	@Override
	public DataOperationsBuilderImpl<I, O> inputPath(final String inputPath) {
		super.inputPath(inputPath);
		return this;
	}

	@Override
	public DataOperationsBuilderImpl<I, O> outputPathInput(final Input<String> ops) {
		super.outputPathInput(ops);
		return this;
	}

	@Override
	public DataOperationsBuilderImpl<I, O> credentialInput(final Input<Credential> credentialInput) {
		super.credentialInput(credentialInput);
		return this;
	}

	@Override
	public DataOperationsBuilderImpl<I, O> credentialsByPath(final Map<String, Credential> credByPath) {
		super.credentialsByPath(credByPath);
		return this;
	}
