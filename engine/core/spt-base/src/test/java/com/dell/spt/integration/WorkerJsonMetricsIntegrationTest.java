...
public class WorkerJsonMetricsIntegrationTest {
	...
	public void workerJsonReturnsLocalMetrics() throws Exception {
		...
		assertEquals(4, first.get("metrics_schema").asInt());
	...
	@Test
	public void fetchReadsUtf8AsExpected() throws Exception {
	...
	@Test
	public void fetchHonorsUtf16Charset() throws Exception {
		HttpServer server = HttpServer.create(new InetSocketAddress(0), 0);
