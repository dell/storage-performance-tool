...
public class TestLoadStepExtension<T extends LoadStep>
	...
	@Override
	public T createLocal(Config baseConfig, List<Extension> extensions, List<Config> contextConfigs,
					MetricsManager metricsManager) {
		// TODO Auto-generated method stub
		throw new UnsupportedOperationException("Unimplemented method 'createLocal'");
	}
}
