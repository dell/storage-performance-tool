...
```bash
java -jar spt-<VERSION>.jar --read --item-data-verify --item-input-file=items.csv ...
```
...
```bash
java -jar spt-<VERSION>.jar --update ...
```
...
```bash
java -jar spt-<VERSION>.jar --delete ...
```
