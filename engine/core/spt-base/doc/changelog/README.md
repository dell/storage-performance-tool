...
| Id | Description |
|----|-------------|
| [BASE-1444](https://spt-issues.atlassian.net/browse/BASE-1444)| Add new option to update contents of recycled items |
| [BASE-1446](https://spt-issues.atlassian.net/browse/BASE-1446)| Add new datetime format |
...
| Id | Description |
|----|-------------|
| [BASE-1437](https://spt-issues.atlassian.net/browse/BASE-1437)| Improve performance of small reads on all-flash storages |
...
| Id | Description |
|----|-------------|
| [BASE-1414](https://spt-issues.atlassian.net/browse/BASE-1414)| Improve performance by changing metrics exchange approach |
| [BASE-1425](https://spt-issues.atlassian.net/browse/BASE-1425)| Retry mechanism for resolving remote file managers |
| [BASE-1426](https://spt-issues.atlassian.net/browse/BASE-1426)| Spt doesn't complete active operations when finishing on time limit |
| [BASE-1428](https://spt-issues.atlassian.net/browse/BASE-1428)| Make amount of specified quantiles variable |
| [BASE-1436](https://spt-issues.atlassian.net/browse/BASE-1436)| Add ability to add duplicates to output list |
...
| Id | Description |
|----|-------------|
| [BASE-1413](https://spt-issues.atlassian.net/browse/BASE-1413)| Fix worker after-test data aggregation |
...
| Id | Description |
|----|-------------|
| [BASE-1401](https://spt-issues.atlassian.net/browse/BASE-1401)| RemoteException in docker image |
| [BASE-1402](https://spt-issues.atlassian.net/browse/BASE-1402)| Spt metrics.output log shows BW in b/s instead of Mb/s |
...
| Id | Description |
|----|-------------|
| [BASE-1397](https://spt-issues.atlassian.net/browse/BASE-1397)| Spt log appends when using the same load-step-id and adds a first weird line that is not yaml |
| [BASE-1391](https://spt-issues.atlassian.net/browse/BASE-1391)| Spt doesn't stop at the count limit |
| [BASE-1389](https://spt-issues.atlassian.net/browse/BASE-1389)| Update whole documentation |
...
| Id | Description |
|----|-------------|
| [BASE-1386](https://spt-issues.atlassian.net/browse/BASE-1386) | Add Pending status handling for unfinished operations | 
...
| Id | Description |
|----|-------------|
| [BASE-1379](https://spt-issues.atlassian.net/browse/BASE-1379) | Last actual concurrency is not aggregated | 
...
| Id | Description |
|----|-------------|
| [BASE-1378](https://spt-issues.atlassian.net/browse/BASE-1378) | Legacy code impacting performance | 
...
| Id | Description |
|----|-------------|
| [BASE-1366](https://spt-issues.atlassian.net/browse/BASE-1366) | Run ID doesn't get exported to Prometheus | 
| [BASE-1367](https://spt-issues.atlassian.net/browse/BASE-1367) | Logs unavailability from browser's HTTP requests |
| [BASE-1368](https://spt-issues.atlassian.net/browse/BASE-1368) | Prometheus exporter failure |
| [BASE-1369](https://spt-issues.atlassian.net/browse/BASE-1369) | Non-unique run ID is generated via starting with REST API |
...
| Id | Description |
|----|-------------|
| [BASE-1364](https://spt-issues.atlassian.net/browse/BASE-1364) | The option "storage-net-node-slice" is not available in base
...
| Id | Description |
|----|-------------|
| [BASE-1357](https://spt-issues.atlassian.net/browse/BASE-1357) | Export run ID in load-step-id metrics.
...
1. [Expression Language](../../src/main/java/com/dell/spt/config/el/README.md) is based on the JSR-341
standard.
...
2. Use YAML instead of JSON in all configuration files. Issue [link](https://spt-issues.atlassian.net/browse/GOOSE-1327).
3. Release automation (release is done by setting the *latest* tag on the source code revision).
4. Spt source repo has been split into the modules: 
    1. spt-base
    2. spt-load-step-pipeline
    3. spt-load-step-weighted
    4. spt-storage-driver-coop
    5. spt-storage-driver-preempt
    6. spt-storage-driver-nio
    7. spt-storage-driver-fs
    8. spt-storage-driver-netty
    9. spt-storage-driver-http
    10. spt-storage-driver-atmos
    11. spt-storage-driver-s3
    12. spt-storage-driver-swift
...
| Id | Description |
|----|-------------|
| [BASE-1279](https://spt-issues.atlassian.net/browse/BASE-1279) | Negative actual concurrency reporting |
| [BASE-1319](https://spt-issues.atlassian.net/browse/BASE-1316) | Swift storage driver: handle multi byte ranges read responses correctly |
| [BASE-1335](https://spt-issues.atlassian.net/browse/BASE-1335) | Prometheus parsing error on Spt metrics.
| [BASE-1349](https://spt-issues.atlassian.net/browse/BASE-1349) | No data latency available in the traces output file |
| [BASE-1350](https://spt-issues.atlassian.net/browse/BASE-1350) | Unable to fetch existing log types via REST API
...
| Id | Description |
|----|-------------|
| [GOOSE-1265](https://spt-issues.atlassian.net/browse/GOOSE-1265) | Log the config for each load step |
| [GOOSE-1315](https://spt-issues.atlassian.net/browse/GOOSE-1315) | Do not create any log files under the `${ctx:step_id}` directory |
| [GOOSE-1317](https://spt-issues.atlassian.net/browse/GOOSE-1317) | Add the CORS related headers to the Remote API responses |
...
1. Get Spt node configuration defaults
2. Get Spt node configuration schema
3. Run a scenario
...
|----|-------------------|
| [GOOSE-1284](https://spt-issues.atlassian.net/browse/GOOSE-1284) | \[S3] Bucket versioning checking request causes 403 response |
| [GOOSE-1293](https://spt-issues.atlassian.net/browse/GOOSE-1293) | Incorrect console rate output |
| [GOOSE-1301](https://spt-issues.atlassian.net/browse/GOOSE-1293) | Auto installer overwrites the manually changed defaults every run
...
| Id | Short Description |
|----|-------------------|
| [BASE-1282](https://spt-issues.atlassian.net/browse/BASE-1282) | Few load operations results are lost sometimes
...
| Id | Short Description |
|----|-------------------|
| [BASE-1276](https://spt-issues.atlassian.net/browse/BASE-1276) | Fails to create the file if the parent directory doesn't exist |
| [BASE-1277](https://spt-issues.atlassian.net/browse/BASE-1277) | Hang for some time when a distributed load step has already finished |
...
dedicate the host for the controller. The remote API is also available to deploy applications on top of Spt node
set such as GUI.

#### 2. Automated Installer

New Spt is delivered as a single jar instead of tarball. This jar installs all the required files automatically if
...
| Id | Short Description |
|----|-------------------|
| [BASE-1226](https://spt-issues.atlassian.net/browse/BASE-1226) | Load operations results queue contains the unhandled elements
...
* (1175) Spt reports and Descriptive Statistics discrepancies
...
1. **[[Extensions Mechanism|v3.6 Extensions]]**
    ...
    `ext` directory of Spt and it's ready to use.
...
2. The connection pool used by Spt moved to the separate project
[netty-connection-pool](https://github.com/akurilov/netty-connection-pool).

3. The source code repository name changed from `spt` to
`spt-base` due to storage driver implementations separation.
...
1. **Modularity**
    ...
    1. **[[Custom Storage Driver Plugin|v3.3 Custom Storage Driver]]**
        ...
        Initially Spt worked via Amazon S3 REST API. Then support for the Dell Atmos and OpenStack
        Swift API had been added. Finally Spt was redesigned to support the work with filesystem
        what made Spt load engine independent on the particular storage type. Currently adding
    ...
    3. Spt [[Components|v3.3 Components]] are available in the Maven Central Repo.

        This will allow to use to embed any Spt functionality into a user application.
...
* (923) Spt 3.1.0 String Index out of bound exception
...
2. Configuration layout change
    ...
    **"storage-net-..."** prefix/path. This was done to differentiate the FS storage
    ...
    provided scenario schema*** (<SPT_DIR>/scenario/schema.json).
...
* Spt 2.4.2 Making loop inclusive
...
Directories, files and objects may be written to a variable path described with width and depth. In order to read back these items spread across the directories and subdirectories Spt should persist the item path into the items.csv output file. Note that the format of the items.csv and perf.trace.csv output files are changed.
...
Any user is welcome to write its own scenarios for Spt. The scenario syntax is described in the corresponding documentation section. The scenario JSON schema allows to validate any custom Spt scenario syntax making the writing the scenarios much easier.
...
java -jar spt.jar	Default scenario (scenario/default.json) is used to run
java -jar spt.jar -I	Semi-interactive mode: await a scenario text from the standard input
java -jar spt.jar -f <PATH>	The scenario specified by <PATH> is used to run
java -jar spt.jar client -f <PATH>	The scenario specified by <PATH> is used to run in the distributed mode

# 2.0.0

General Notes
Spt 2.x is no more compatible with previous versions. That was done to perform a big switch to a new Configuration Layout and Scripting Engine.

The new version of Spt is expected to be
...
Spt is able to perform a load to several target buckets, using several users or anything else in the new version.
Weighted Load Case Support
Spt is able to perform a load described by a set of the load type ratios, for example: 20% of the requests are Write requests and 80% are Read ones.
Copy Mode
...
Spt 1.2.0 - perf.sum.csv is sometimes 0 bytes	Bug	Dec 20, 2015	Blocker	CLOSED	Cannot Reproduce
...
For details see:
Spt Dynamic Configuration Values design notes.
...
Non-functional
Availability of Spt as a Docker image in the registry
For details see: How to use Spt with Docker
Fixed bugs
Summary	T	Created	P	Status	Resolution
Spt 1.3.2 Small Object Write to local NFS mounted directory performance
...
Custom HTTP headers for the requests generated by Spt.
...
Spt indicates that it's exiting but the process hung	Dec 13, 2015	Major	CLOSED	Fixed
...
Spt 1.1.3 Writing to bucket with prefix does not work in distributed mode	Nov 30, 2015	Major	CLOSED	Fixed
...
Fixed bugs:
Spt 1.1.1 - Unable to read in distributed mode	Nov 17, 2015
load client hangs	Nov 15, 2015
Atmos API: read fails via namespace interface	Nov 13, 2015
Spt doesn't exit/show error message if invalid items list path is specified	Nov 13, 2015
Spt 1.1 - Read Hung

# 1.1.1

Fixed bugs:
Spt 1.1 - Read Hung CLOSED
Spt doesn't exit/show error message if invalid items list path is specified CLOSED
...
Spt load engine is reworked in the way to be more abstract. New load engine supports not only data items (e.g. objects) but another entiites also. There are a load engine implementation which is able to process the containers (S3 buckets or Swift containers). Create, read and delete operations are supported.
See:
...
Fixed Bugs
Spt to supress the following debug message: DEBUG | BasicDataItemProducer | 7-S3-Read-60x4x2 | Failed to transfer the data items

# 1.0.2

Fixed bugs:
Spt 1.0 - Multi-client read imbalance CLOSED

# 1.0.1

Fixed bugs:
Spt 1.0 - is not working CLOSED
...
Spt must unambiguously report configuration of run
...
New Features
Spt embedding. It must be possible to use Spt as a library for load generation.
...
New Features and Enhancements
User got control over Spt speed. User can specify "think time" between 2 successive operations.
...
Now Spt has possibility to start test from Web UI (was tested in Firefox and Google Chrome, doesn’t support IE)
Spt has set of parameters, which could be configured by a shortcuts:
...
Spt supports standalone vipr environments, so if needed datanodes may be listed following way:
...
Copy spt tar file to the client host
Do # tar –xvf spt-0.5.0.tar
Do # java -jar spt-0.5/spt.jar webui
Now webui is accessible by http://<host_ip>:8080/

# 0.4

New metric: Latency (actually response latency): this value is measured in nanoseconds and shows how much time passed since spt sent first byte to storage till first byte  from storage was returned. This value depends on object size in case of Create or Update, and doesn't in case of Read and Delete

Changed format:

perf.trace.csv:
removed some unnecessary data
added response latency (named as latency) - time required to get first byte from storage after request was sent from Spt
perf.avg.csv:
added response latency (named as latency) - time required to get first byte from storage after request was sent from Spt
...
$ java –Drun.time=10.hours –Drun.scenario.name=chain –Dscenario.chain.load=create,update,read,update,read,…,update,read,delete <OTHER_USER_SPECIFIC_ARGUMENTS> –jar spt-0.1.4/spt.jar
