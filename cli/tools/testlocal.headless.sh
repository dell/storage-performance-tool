...
# spt single-host S3 write test (headless). Loads defaults from repo-root .env.
#
# Usage:
#   ./tools/testlocal.headless.sh                                 # defaults from .env
#   ./tools/testlocal.headless.sh --use-rdma                      # enable RDMA passthrough
#   ./tools/testlocal.headless.sh --threads 8 --object-size 4MB   # override defaults
#   S3_BUCKET=mybucket ./tools/testlocal.headless.sh              # env override
