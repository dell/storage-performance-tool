...
func init() {
	...
	// Mixed Workload Distribution Options (defaults: GET 45 / PUT 30 / DELETE 15 / STAT 10)
	...
	runCmd.Flags().Int("put-distrib", scenario.MixedDefaultPutDistrib, "Percentage of PUT (write) operations for mixed workload (default: 30)")
	...
	runCmd.Flags().Int("stat-distrib", scenario.MixedDefaultStatDistrib, "Percentage of STAT (HEAD) operations for mixed workload (default: 10)")
