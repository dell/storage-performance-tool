		...
		Steps: []StepSummary{
			{
				...
				Metrics: &PhaseMetrics{
					...
					BandwidthAvgMiBps: 80.4,
					DurationSeconds:   30,
					DurationHuman:     "30s",
					ObjectSizeHuman:   "4.00 MiB",
				},
				OperationBreakdown: []OperationBreakdown{
					{Operation: "READ", ConfiguredShare: &configuredRead, ActualShare: &actualRead, ActualOps: 450, Metrics: PhaseMetrics{SuccessCount: 445, FailureCount: 5, DataBytes: 1866465280, ThroughputAvgOps: 14.8, BandwidthAvgMiBps: 59.3, LatencyMedianMs: 6.2}},
					{Operation: "STAT", ConfiguredShare: &configuredStat, ActualShare: &actualStat, ActualOps: 302, Metrics: PhaseMetrics{SuccessCount: 301, FailureCount: 1, DataBytes: 0, ThroughputAvgOps: 10.0, BandwidthAvgMiBps: 0, LatencyMedianMs: 3.1}},
					{Operation: "CREATE", ConfiguredShare: &configuredCreate, ActualShare: &actualCreate, ActualOps: 153, Metrics: PhaseMetrics{SuccessCount: 151, FailureCount: 2, DataBytes: 633339904, ThroughputAvgOps: 5.1, BandwidthAvgMiBps: 21.1, LatencyMedianMs: 8.7}},
					{Operation: "DELETE", ConfiguredShare: &configuredDelete, ActualShare: &actualDelete, ActualOps: 107, Metrics: PhaseMetrics{SuccessCount: 103, FailureCount: 4, DataBytes: 0, ThroughputAvgOps: 3.6, BandwidthAvgMiBps: 0, LatencyMedianMs: 5.2}},
				},
			},
		},
